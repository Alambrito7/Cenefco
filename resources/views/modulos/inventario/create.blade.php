                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">
                                        ...
                                        Código AF <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="codigo_af" class="form-control" 
                                           value="{{ old('codigo_af') }}" required 
                                           placeholder="Ej: AF-001">
                                    <div class="invalid-feedback">
                                        Por favor ingrese el código AF.
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <textarea name="observaciones" class="form-control" rows="3" 
                                              placeholder="Observaciones adicionales o notas importantes...">{{ old('observaciones') }}</textarea>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label fw-bold">
