    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <h1 class="header-title">
                ...
                Panel de Control Agente Académico	
            </h1>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="module-card" data-module="registros">
                ...
                <h5 class="module-title">Docentes</h5>
                <p class="module-description">Gestión completa de docentes</p>
                <a href="{{ route('docentes.index') }}" class="module-btn">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            ...
            <i class="fas fa-book module-icon"></i>
                <h5 class="module-title">Cursos</h5>
                <p class="module-description">Control de cursos</p>
                <a href="{{ route('cursos.index') }}" class="module-btn">
                    <i class="fas fa-arrow-right me-2"></i>
                    Acceder al módulo
                </a>
            </div>
