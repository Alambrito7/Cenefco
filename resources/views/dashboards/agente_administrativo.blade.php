    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="module-card" data-module="registros">
                ...
                <h5 class="module-title">Personal</h5>
                <p class="module-description">Gestión completa del personal</p>
                <a href="{{ route('personals.index') }}" class="module-btn">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="module-card" data-module="registros">
                ...
                <p class="module-description">Gestión completa de los clientes</p>
